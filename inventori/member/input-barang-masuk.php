								...
								<tr>
					              ...
					              <th>
				              		<select name="kode_barang">
										...
										<option value="1">Laptop</option> //laptop
										<option value="2">Keyboard</option> //keyboard
										<option value="3">Mouse</option> //mouse
										<option value="4">Adaptor</option> //adaptor
										<option value="5">Infocus</option> //infocus
										<option value="6">Printer</option> //printer
									</select>
					              </th>
					            </tr>
				              	<tr>
