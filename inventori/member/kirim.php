					...
					<form action="" method="post" name="form1">
						<div class="col s12 card-panel z-depth e-input-field"> <br>
							<table class="highlight">
								...
								<tr>
					            	<th>Kode Barang</th>
					        		<th><input type="text" name="kode_barang" value="<?php echo $kode; ?>"></th>
					            </tr>
				              	<tr>
				                	<th>Nama Barang</th>
				                	<th><input type="text" name="nama_barang" value="<?php echo $name;?>"></th>
				              	</tr>
				              	<tr>
				                	<th>Serial Number</th>
				                	<th><input type="text" name="serial" value="<?php echo $serial;?>"></th>
				              	</tr>
				              	<tr>
				              		<th>Kondisi</th>
				              		<th>
				             	...
				             	<tr>
				              	...
				              	<tr>
				                	<th>Operator</th>
				                	<th><input type="text" name="operator" value="<?php echo $nama;?>"></th>
				              	</tr>
				              	<tr>
