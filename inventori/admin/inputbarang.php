			  ...
			  <div id="admin" class="col s10 offset-s1"> <br>
			    <div class="card material-table">
			      <div class="table-header">
			        <span class="table-title">Input Barang</span>
			        <div class="actions">
			          <a href="input-barang-masuk.php" class="waves-effect btn-flat nopadding"><i class="material-icons">archive</i></a>
			        ...
			        <tbody>
			        	...
			        	<?php 
							...
							while($user_data = mysqli_fetch_array($result)) { 
				                ...
				                echo "<td> <a href='edit-barang-masuk.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> <a data-id='1' class='hapus' href='delete-barang-masuk.php?id=$user_data[id]' style='margin-left:5px; text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> </td></tr>";
				            }
