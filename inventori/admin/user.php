			  ...
			  <div id="admin" class="col s10 offset-s1"> <br>
			    <div class="card material-table">
			      <div class="table-header">
			        ...
			        <div class="actions">
			          <a href="tambah-user.php" class="waves-effect btn-flat nopadding"><i class="material-icons">person_add</i></a>
			        ...
			        <tbody>
			        	<?php 
							...
							while($user_data = mysqli_fetch_array($result)) { 
				                ...
				                echo "<td> <a href='edit-user.php?id=$user_data[id]' style=' text-decoration: none;'><i class='material-icons' title='Edit $test'>mode_edit</i></a> <a data-id='1' class='hapus' href='delete-user.php?id=$user_data[id]' style=' text-decoration: none;'><i class='material-icons' title='Hapus $test'>delete</i></a> <a href='edit-password.php?id=$user_data[id]' style='text-decoration: none;'><i class='material-icons' title='Ganti Password $test'>lock</i></a> </td></tr>";
				            }
